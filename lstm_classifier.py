...
encoder_1 = LSTM(latent_dim, return_sequences=True,  W_regularizer=l2(0.001),
                 recurrent_dropout=0.3)(encoder_inputs)
encoder_2 = LSTM(latent_dim*2,  W_regularizer=l2(0.001), recurrent_dropout=0.3)(encoder_1)
# encoder_states = [state_h, state_c]
dense_1 = Dense(128, activation='relu')(encoder_2)
dropout_1 = Dropout(0.50)(dense_1)
dense_2 = Dense(128, activation='relu')(dropout_1)
dropout_2 = Dropout(0.50)(dense_2)
dense_outputs = Dense(nb_targets, activation='softmax')(dense_1)
...
model.summary()
model.fit(encoder_input_data, y_encoded,
